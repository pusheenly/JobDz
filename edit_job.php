...
$cur = [
    ...
    'specialty'         => $_POST['specialty']         ?? $job['specialty']         ?? '',
    'city'              => $_POST['city']              ?? $job['city']              ?? '',
    'salary'            => $_POST['salary']            ?? $job['salary']            ?? '',
    'contract_type'     => $_POST['contract_type']     ?? $job['contract_type']     ?? '',
    'work_mode'         => $_POST['work_mode']         ?? $job['work_mode']         ?? '',
    'experience_level'  => $_POST['experience_level']  ?? $job['experience_level']  ?? '',
    'description'       => $_POST['description']       ?? $job['description']       ?? '',
    'skills'            => $_POST['skills']            ?? $job['skills']            ?? '',
    'duration_days'     => $_POST['duration_days']     ?? $job['duration_days']     ?? 7,
    ...
    'experience'        => $_POST['experience']        ?? $job['experience']        ?? '',
    'education_level'   => $_POST['education_level']   ?? $job['education_level']   ?? '',
    'language_required' => $_POST['language_required'] ?? $job['language_required'] ?? '',
];
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="ph-left">
                <div class="ph-icon"><i class="ti ti-pencil"></i></div>
                <div>
                    <div class="ph-badge"><i class="ti ti-edit"></i> Edit Listing</div>
                    <div class="ph-title">Edit Job Listing</div>
                    <div class="ph-sub">Update your job details and manage positions</div>
                </div>
            </div>
        </div>

        <form method="POST" action="edit_job.php?id=<?php echo $jobId; ?>" class="form-card" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="ac-wrap" id="wrap-specialty">
                            ...
                            <input type="text" name="specialty" id="input-specialty"
                                value="<?php echo e($cur['specialty']); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="chip-grid" id="expLevelChips" style="margin-top:4px">
                            ...
                            foreach ($expChips as $val => $opt): ?>
                                <span class="fchip <?php echo $cur['experience_level'] === $val ? 'active' : ''; ?>"
                        ...
                        <input type="hidden" name="experience_level" id="exp_level_hidden"
                            value="<?php echo e($cur['experience_level']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="ac-wrap" id="wrap-experience">
                            ...
                            <input type="text" name="experience" id="input-experience"
                                value="<?php echo e($cur['experience']); ?>"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="chip-grid" style="margin-top:4px">
                            <?php foreach ($contractChips as $val => $opt): ?>
                                <span class="fchip <?php echo $cur['contract_type'] === $val ? 'active' : ''; ?>"
                                    data-val="<?php echo e($val); ?>"
                        ...
                        <input type="hidden" name="contract_type" id="contract_type_hidden"
                            value="<?php echo e($cur['contract_type']); ?>">
                        <div class="form-hint">Select one or leave empty</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="wt-row" id="wtRow">
                            <div class="wt-btn <?php echo $cur['work_mode'] === 'On-site' ? 'active' : ''; ?>" data-val="On-site">
                                <i class="ti ti-building"></i> On-site
                            </div>
                            <div class="wt-btn <?php echo $cur['work_mode'] === 'Remote' ? 'active' : ''; ?>" data-val="Remote">
                                <i class="ti ti-home"></i> Remote
                            </div>
                            <div class="wt-btn <?php echo $cur['work_mode'] === 'Hybrid' ? 'active' : ''; ?>" data-val="Hybrid">
                                <i class="ti ti-arrows-shuffle"></i> Hybrid
                            </div>
                        </div>
                        <select name="work_mode" id="work_mode_select">
                            <option value=""></option>
                            <option value="On-site" <?php echo $cur['work_mode'] === 'On-site' ? 'selected' : ''; ?>>On-site</option>
                            <option value="Remote" <?php echo $cur['work_mode'] === 'Remote'  ? 'selected' : ''; ?>>Remote</option>
                            <option value="Hybrid" <?php echo $cur['work_mode'] === 'Hybrid'  ? 'selected' : ''; ?>>Hybrid</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="chip-grid" style="margin-top:4px">
                            <?php foreach ($durationChips as $val => $opt): ?>
                                <span class="fchip <?php echo $cur['duration_days'] == $val ? 'active' : ''; ?>"
                                    data-val="<?php echo e($val); ?>"
                                    data-group="duration"
                                    style="background:<?php echo $opt['bg']; ?>;color:<?php echo $opt['color']; ?>;border-color:<?php echo $opt['border']; ?>;"
                        ...
                        <input type="hidden" name="duration_days" id="duration_hidden"
                            value="<?php echo e($cur['duration_days']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="chip-grid" style="margin-top:4px">
                            <?php foreach ($eduChips as $val => $opt): ?>
                                <span class="fchip <?php echo $cur['education_level'] === $val ? 'active' : ''; ?>"
                                    data-val="<?php echo e($val); ?>"
                        ...
                        <input type="hidden" name="education_level" id="education_hidden"
                            value="<?php echo e($cur['education_level']); ?>">
                        <div class="form-hint">Select one or leave empty</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="ac-wrap" id="wrap-language">
                            ...
                            <input type="text" name="language_required" id="input-language"
                                value="<?php echo e($cur['language_required']); ?>"
                ...
                <div class="form-row single">
                    <div class="form-group">
                        ...
                        <textarea name="description"
                            placeholder="Provide a comprehensive overview of the position..."><?php echo e($cur['description']); ?></textarea>
                ...
                <div class="form-row single">
                    <div class="form-group">
                        ...
                        <textarea name="responsibilities"
                            placeholder="List key responsibilities and duties..."><?php echo e($cur['responsibilities']); ?></textarea>
                ...
                <div class="form-row single">
                    <div class="form-group">
                        ...
                        <textarea name="requirements"
                            placeholder="Specify essential and nice-to-have requirements..."><?php echo e($cur['requirements']); ?></textarea>
                ...
                <div class="form-row single">
                    <div class="form-group">
                        ...
                        <textarea name="benefits"
                            placeholder="e.g. Health insurance&#10;Remote work&#10;Flexible hours"><?php echo e($cur['benefits']); ?></textarea>
                ...
                <div class="form-row single">
                    <div class="form-group">
                        ...
                        <textarea name="skills"
                            placeholder="e.g. React, Node.js, MongoDB, REST APIs"><?php echo e($cur['skills']); ?></textarea>
